...
bucket = storage_client.bucket("pa_mlops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "summer-ranger-477910-v8.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://pa_mlops/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
